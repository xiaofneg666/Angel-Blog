...
.hero-overlay {
  ...
  right: 0;
  padding: 2rem;
  background: linear-gradient(transparent, var(--hero-overlay));
  color: white;
}
...
.comments-header {
  border-bottom: 2px solid #e6f9f0;
